...
public class ManifestacoesControllerRest {
	...
	@PutMapping("/{id}")
	public ResponseEntity<Object> atualizar(@RequestBody @Valid ManifestacaoForm manifestacaoForm, @PathVariable int id){
		...
		ManifestacaoDto manifestacaoDto = crudOuvidoriaService.updateManifestacao(optional.get(), manifestacaoForm);
		
		return ResponseEntity.status(HttpStatus.OK).body(manifestacaoDto);
